...
**Clean, ad-free weather forecasts for any city — powered by live OpenWeather data.**
...
- **Search any city worldwide** — instant results as you type
...
```bash
# 1. Clone the repo
git clone https://github.com/Kerim-Myratlyev/MeteoMaster.git
cd MeteoMaster

# 2. Add your OpenWeather API key
#    Get a free key at https://openweathermap.org/api
#    Create a .env file (or config.js) and add:
...
> **Note:** You'll need a free OpenWeather API key. Never commit your real key — keep it in a `.env` file and add `.env` to `.gitignore`.
...
MIT © Kerim Myratlyev — see [`LICENSE`](LICENSE).
